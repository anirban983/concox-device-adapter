...
const getHexBytes = (msg) => {
    ...
    i = 0
    while(i<msg.length) {
        hexBytes += '0X' + msg.substring(i, i+2) + ' '
        i += 2
    }
    hexBytes = hexBytes.trimEnd()
    return hexBytes
}
...
const crc16 = (buf) => {
    ...
    return decimalToHex(crcX).toUpperCase();
}

module.exports = { insertSpaceEveryNPos, hexToBinary, binaryToDecimal, decimalToBinary, 
    binaryToHex, hexToDecimal, decimalToHex, crc16, getHexBytes }